      ...
      <div className="container max-w-lg relative z-10">
        ...
        <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 p-10 md:p-16 shadow-[0_0_80px_rgba(0,0,0,0.5)] rounded-sm">
          ...
          <div className="mt-16 pt-10 border-t border-white/5 text-center">
            <p className="text-[10px] text-white/20 uppercase tracking-widest mb-6 font-bold">New to the Collective?</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/membership"
                className="inline-block border border-white/10 hover:border-white text-white font-bold py-4 px-12 uppercase tracking-widest text-[10px] transition-all hover:bg-white/5"
              >
                View Memberships
              </Link>
            </div>
