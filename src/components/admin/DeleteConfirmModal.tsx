...
interface DeleteConfirmModalProps {
  showDeleteConfirm: { id: string, type: string } | null;
  setShowDeleteConfirm: (val: any) => void;
  executeDelete: () => void;
}

export default function DeleteConfirmModal({ showDeleteConfirm, setShowDeleteConfirm, executeDelete }: DeleteConfirmModalProps) {
